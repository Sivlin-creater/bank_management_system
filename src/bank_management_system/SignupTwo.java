...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        add(dob);
        String incomecategory[]= {"Null", "< 150,000", "< 250,000", "< 500,000", "Up to 1,000,000"};
        ...
        add(email);
        String educationValues[]= {"None", "Graduated", "Post-Graduation", "Doctorate", "Others"};
        ...
        JLabel city = new JLabel("Another Number:");
        ...
        ano.setBounds(300, 490, 400, 30);
        add(ano);
        
        JLabel state = new JLabel("Second Citizen:");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
                Conn c = new Conn();
                String query = "Insert into signuptwo values('" + formno + "', '" + sreligion + "', '" + scategory + "', '" + sincome + "', '" + seducation + "', '" + soccupation + "', '" + span + "', '" + sano + "', '" + ssecondcitizen + "', '" + existingaccount + "')";
